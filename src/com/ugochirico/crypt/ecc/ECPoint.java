...
public abstract class ECPoint {
     ...
     */
    public abstract ECPoint randomize(Random rand);
     ...
     */
    public abstract ECPoint add(ECPoint Q) throws DifferentCurvesException;
     ...
     * @exception   DifferentCurvesException    if this and Q lay on different curves
     */
    public abstract ECPoint subtract(ECPoint Q) throws DifferentCurvesException;
    ...
    public ECPoint multiply(BigInteger k) {
        ...
        ECPoint Q = Q = (ECPoint)P.clone();
        ECPoint P2 = P .twice().normalize(); ECPoint M  = P .negate();
        ECPoint P3 = P .add(P2).normalize(); ECPoint M3 = P3.negate();
        ECPoint P5 = P3.add(P2).normalize(); ECPoint M5 = P5.negate();
        ECPoint P7 = P5.add(P2).normalize(); ECPoint M7 = P7.negate();
        ECPoint P9 = P7.add(P2).normalize(); ECPoint M9 = P9.negate();
        int i = h.bitLength() - 2;
        while (i >= 4) {
