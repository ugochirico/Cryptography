...
import com.ugochirico.crypt.ecc.DifferentCurvesException;
 ...
 */
public class ECPointp extends ECPoint
{

    protected static final BigInteger ONE = BigInteger.ONE;//.valueOf(1L);
...
//    public GFp y;
    ...
    ECPointp(ECp E, GFp x, GFp y)
        ...
        this.z = E.gfOne;
        if (!E.contains(this)) {
            throw new PointNotOnCurveException("2");
        }
    }
    ...
    ECPointp(ECp E, GFp x, int yBit)
        ...
        if (x.isZero()) {
            ...
            if (beta == null) {
                throw new PointNotOnCurveException("1");
            }
...
//        }
     ...
     */
    private ECPointp(ECp E, GFp x, GFp y, GFp z)
        throws DifferentFieldsException, PointNotOnCurveException {
...
//        }
        ...
        this.z = z;
        if (!E.contains(this)) {
            throw new PointNotOnCurveException("3");
        }
    }
    ...
    public boolean equals(Object Q) {
        if (Q instanceof ECPointp && this.isOnSameCurve((ECPointp)Q)) {
            ECPointp P = (ECPointp)Q;
    ...
    public ECPoint randomize(Random rand) {
        return new ECPointp((ECp)this.E, rand);
    }
    ...
    public ECPoint normalize() {
        if (this.isZero()) {
            ...
            ECPointp P = (ECPointp)this.clone();
            GF z2 = z.square();
            GF z3 = z.multiply(z2);
            return new ECPointp((ECp)E,
                (GFp)x.divide(z2),
                (GFp)y.divide(z3),
                ((ECp)E).gfOne);
            /*
    ...
    public ECPoint negate() {
        return new ECPointp((ECp)E, (GFp)x, (GFp)y.negate(), z);
    }
     ...
     */
    public ECPoint add(ECPoint Q) throws DifferentCurvesException {
...
//        }
        ...
        ECPointp R = (ECPointp)Q; // a shorthand to make the expressions more readable
        /*
     ...
     * @exception   DifferentCurvesException    if this and Q lay on different curves
     */
    public ECPoint subtract(ECPoint Q) throws DifferentCurvesException {
        return add(Q.negate());
    }
    ...
    public byte[] toByteArray(int formFlags) {
        ...
        ECPointp thisNorm = (ECPointp)this.normalize();
