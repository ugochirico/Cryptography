...
public class GF2mUtil {
    ...
    public static short[] getIrredArray(int m) {
        return use1363 ? irred1363[m] : irredX9F1[m];
    }

    public static GF2m getIrredPoly(int m) {
    ...
    public static short[] getTraceTable(int m) {
        if (use1363) {
            return (0 < m && m < GF2mTrace.tr1363.length) ? GF2mTrace.tr1363[m] : null;
        } else {
            return (0 < m && m < GF2mTrace.trX9F1.length) ? GF2mTrace.trX9F1[m] : null;
        }
    }
