 ...
 */
public class ECPoint2m extends ECPoint
{
...
//    GF2m y;
     ...
     */
    ECPoint2m(EC2m E, GF2m x, GF2m y)
     ...
     */
    ECPoint2m(EC2m E, GF2m x, int yBit)
...
//        }
    ...
    public boolean equals(Object Q) {
        return Q instanceof ECPoint2m            && this.isOnSameCurve((ECPoint2m)Q)            && x.equals(((ECPoint2m)Q).x)            && y.equals(((ECPoint2m)Q).y)            ;
    }
    ...
    public ECPoint randomize(Random rand) {
        return new ECPoint2m((EC2m)this.E, rand);
    }
    ...
    public ECPoint negate() {
        return new ECPoint2m((EC2m)E, (GF2m)x, (GF2m)x.add(y));
    }
    ...
    public ECPoint add(ECPoint Q) throws DifferentCurvesException {
        ...
        ECPoint2m R = (ECPoint2m)Q; // a shorthand to make the expressions more readable
        if (x.equals(R.x)) {
            ...
            return new ECPoint2m((EC2m)E, (GF2m)x3, (GF2m)y3);
        }
    }
    ...
    public ECPoint twice() {
        ...
        return new ECPoint2m((EC2m)E, (GF2m)x2, (GF2m)y2);
    }
