...
public class ECPrivateKey
{
    ...
    public static ECPrivateKey generate(ECCurve curve, Random rand)
    {
    ...
    // public key is W = s * G
    private ECPrivateKey(ECCurve E, Random rand)
    {
		if (E == null)
		{
    ...
    // private key is s in the range [1, r-1]
    // public key is W = s * G
    public ECPrivateKey(ECCurve curve, BigInteger s)
    {
        if (s == null)
		{
    ...
    public ECPrivateKey(BigInteger s, ECPublicKey pubKey)
    {
//        if (s == null)
//        {
//            throw new IllegalArgumentException("invalid argument: s");
...
//      3. c = (i + f) mod r.
        c = sessionPriKey.m_W.x.add(f).mod(m_W.E.r);
...
//      4. d = (u – sc) mod r.
    ...
    */
    ...
    public ECSignature ECSP_DSA(BigInteger f)
    {
        ...
        c = sessionPriKey.m_W.x.mod(m_W.E.r);
//      c = i.mod(m_curve.r);
        if(c.equals(BigInteger.ZERO))
            return ECSP_DSA(f);
