...
//        	System.out.println(f1.toString(16));
...
//      2. P = d G + c W        
        ECPoint P = ECPoint.simultaneous(sig.m_c, m_W, sig.m_d, m_W.E.G);
...
//        ECPoint P = m_W.E.G.multiply(sig.m_d).add(m_W.multiply(sig.m_c));
        ...
        // 4. f = (c - Px) mod n
        BigInteger f = sig.m_c.subtract(P.x).mod(m_W.E.r);
    ...
    */
    public boolean ECVP_DSA(BigInteger f, ECSignature sig)
    {
        ...
        // 3. P = h1G + h2W
        //ECPoint P = m_W.E.G.multiply(h1).add(m_W.multiply(h2));
        ECPoint P = ECPoint.simultaneous(h1, m_W.E.G, h2, m_W);
