...
package com.ugochirico.crypt.blowfish;
...
public   void setKey(byte[] key)
    ...
    */
public   byte[] stringEncrypt(String inString)
   {
...
public   byte[] encrypt(byte[] bytes)
   {
      ...
      for(int i = 0; i < 8; i++)
      {
          inBytes[i] = (byte)rand.nextInt();
      }
      ////////////////////////////////////////////
      
      //////////////////////////////////////////////////
      // old implementation doesn't work with J2ME
      //byte[] iv = new byte[8];
      //rand.nextBytes(iv);
    ...
    */
public   String stringDecrypt(byte[] inBytes)
   {
...
public   void encrypt (byte[] in, int off, byte[] out, int outOff)
   {
   ...
   public void decrypt (byte[] in, int off, byte[] out, int outOff)
   {
      int L = (((in[off++] & 0xff) << 24) | ((in[off++] & 0xff) << 16) |
